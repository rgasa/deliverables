...
COMMENT ON TABLE ORA01.TABLE3 IS 'テーブル3'
/

COMMENT ON COLUMN ORA01.TABLE3.ID IS 'ID'
/

COMMENT ON COLUMN ORA01.TABLE3.NAME IS '名前'
/

COMMENT ON COLUMN ORA01.TABLE3.TEL IS '電話番号'
/

COMMENT ON COLUMN ORA01.TABLE3.ADDRESS IS '住所'
/
